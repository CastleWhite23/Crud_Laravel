            ...
            <div class="card-body">
                <form action="{{ route('roles.store') }}" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" style="border-radius: 25px;">
                            @if ($errors->has('name'))
                    ...
                    <!-- Botão Enviar -->
                    <div class="mb-3 row">
                        <input type="submit" class="col-md-3 offset-md-5 btn btn-success" value="Adicionar Função" style="border-radius: 25px; padding: 10px 20px;">
                    </div>
